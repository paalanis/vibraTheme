...
$stmt = mysqli_prepare($conexion, "SELECT id_marca, nombre FROM tb_marca WHERE id_marca = ?");
...
<form class="form-horizontal" role="form" id="formulario_nuevo"
      onsubmit="event.preventDefault(); modifica('marca')">
<div class="modal-header"><h4 class="modal-title">Modificar Marca</h4></div><br>
