...
$stmt = mysqli_prepare($conexion, "SELECT id_tipo, nombre FROM tb_tipo WHERE id_tipo = ?");
...
<form class="form-horizontal" role="form" id="formulario_nuevo"
      onsubmit="event.preventDefault(); modifica('tipo')">
<div class="modal-header"><h4 class="modal-title">Modificar Tipo</h4></div><br>
