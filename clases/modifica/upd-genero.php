...
$stmt = mysqli_prepare($conexion, "SELECT id_genero, nombre FROM tb_genero WHERE id_genero = ?");
...
<form class="form-horizontal" role="form" id="formulario_nuevo"
      onsubmit="event.preventDefault(); modifica('genero')">
<div class="modal-header"><h4 class="modal-title">Modificar Género</h4></div>
<br>
