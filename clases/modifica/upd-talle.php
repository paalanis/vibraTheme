...
$stmt = mysqli_prepare($conexion, "SELECT id_talle, nombre FROM tb_talle WHERE id_talle = ?");
...
<form class="form-horizontal" role="form" id="formulario_nuevo"
      onsubmit="event.preventDefault(); modifica('talle')">

<div class="modal-header">
  <h4 class="modal-title">Modificar Talle</h4>
</div>
<br>
    ...
    <div class="form-group form-group-sm">
      ...
      <div class="col-lg-9">
        <input type="text" class="form-control" autocomplete="off"
               id="dato_nombre" value="<?php echo $nombre; ?>" required autofocus>
        <input type="hidden" id="dato_id" value="<?php echo (int)$id_val; ?>">
      </div>
    </div>
   </fieldset>
  </div>
