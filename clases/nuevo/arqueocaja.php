...
// Ventas por condición — LEFT JOIN para no perder ventas sin condición asignada
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4><?php echo htmlspecialchars($fecha, ENT_QUOTES, 'UTF-8'); ?> - Arqueo de Caja N°
          <span class="label label-default"><?php echo $cierre_actual; ?></span>
        </h4>
      </div>
        ...
        <ul class="list-group">
          ...
          foreach ($rows_retiros as $row) {
              echo '<li class="list-group-item list-group-item-' . htmlspecialchars($row['color']) . '">'
                 ...
                 . '<span class="badge badge-primary badge-pill">$ ' . $row['monto'] . '</span></li>';
              $retiro += $row['monto'];
          }
