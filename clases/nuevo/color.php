...
$stmt = mysqli_prepare($conexion, "SELECT id_color, nombre FROM tb_color ORDER BY nombre ASC");
...
<form class="form-horizontal" role="form" id="formulario_nuevo"
      onsubmit="event.preventDefault(); nuevo('color')">
<div class="modal-header"><h4 class="modal-title">Colores</h4></div><br>
     ...
     <div class="panel-body" style="height:225px; overflow-y:auto">
      <table class="table table-striped table-hover">
       ...
       <tbody>
        ...
        <?php endforeach; ?>
        <?php if (empty($rows)): ?><tr><td colspan="2">No hay colores cargados.</td></tr><?php endif; ?>
       </tbody>
      </table>
     </div>
    </div>
...
$(function() {
  $('.ver_modal').click(function() {
    ...
    $('#panel_inicio').load("clases/modifica/upd-color.php", {id: id});
  });
});
</script>
