...
$stmt = mysqli_prepare($conexion, "SELECT id_talle, nombre FROM tb_talle ORDER BY nombre ASC");
...
<form class="form-horizontal" role="form" id="formulario_nuevo"
      onsubmit="event.preventDefault(); nuevo('talle')">

<div class="modal-header">
  <h4 class="modal-title">Talles</h4>
</div>
<br>
     ...
     <div class="panel-body" style="height:225px; overflow-y:auto">
      <table class="table table-striped table-hover">
       ...
       <tbody>
        ...
        <?php endforeach; ?>
        <?php if (empty($rows)): ?>
          <tr><td colspan="2">No hay talles cargados.</td></tr>
        <?php endif; ?>
       </tbody>
      </table>
     </div>
