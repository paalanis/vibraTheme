...
<div class="modal-header">
   <h4 class="modal-title">Reimprimir ticket del día</h4>
</div>
<br>
 ...
 <div class="col-lg-6">
   <fieldset>
      <div class="form-group form-group-sm">
        <label  class="col-lg-3 control-label">Seleccione fecha</label>
        <div class="col-lg-9">
          <input type="date" class="form-control" id="dato_fecha" name="dato_fecha" value="<?php echo $hoy;?>" aria-describedby="basic-addon1" required>
        </div>
      </div>
     </fieldset>
 </div>
 ...
 <div class="col-lg-6">
  ...
  <div class="modal-footer">
        ...
        <div class="col-lg-5">
          ...
          <button type="button" id="boton_buscar" class="btn btn-primary" onclick="reporte('ticket')">Buscar</button>   
          </div>
        </div>
      </div>  
  </div>
